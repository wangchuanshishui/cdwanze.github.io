...
![img](images/layers.png "SQLAlchemy layer diagram")
...
# 非ORM风格<a id="orgheadline34"></a>

## 创建一个Engine<a id="orgheadline10"></a>

创建一个 `Engine` 对象实际上对应的就是和数据库的连接操作。具体是通过 `create_engine` 函数创建的Engine对象，其一开始并没有实际连接数据库，只有具体要求某个操作的时候才会去连接。

### 连接sqlite3<a id="orgheadline7"></a>

#### 连接sqlite3 in-memory<a id="orgheadline5"></a>
...
#### 连接sqlite3 on-disk<a id="orgheadline6"></a>
...
### 测试数据库是否存在<a id="orgheadline13"></a>
...
## 创建一个Table对象<a id="orgheadline23"></a>
...
### 利用已存在的Table<a id="orgheadline15"></a>
...
### 实际在数据库中创建表格<a id="orgheadline16"></a>
...
#### mysql方言的额外类型<a id="orgheadline18"></a>
...
### postgresql额外的类型<a id="orgheadline20"></a>
...
### Oracle额外的类型<a id="orgheadline21"></a>
...
### 更多的类型支持<a id="orgheadline22"></a>

前面谈及的sqlalchemy\_util模块里面有很多额外的类型支持。

## insert语句<a id="orgheadline24"></a>
...
### ResultProxy对象<a id="orgheadline27"></a>
...
### RowProxy对象<a id="orgheadline28"></a>
...
### 交叉连接或笛卡尔积<a id="orgheadline30"></a>
...
## CRUD操作<a id="orgheadline42"></a>

### 增加记录<a id="orgheadline35"></a>
...
-   **filter\_by方法:** filter\_by方法类似filter方法，除了如上面的User.name要写成name，也就是直接引用表格的列名。

-   **order\_by方法:** 对应select语句的order by字句。

    order_by(User.id)[1:3]

然后上面还揭示了 Query 对象很重要的一个特性，其支持python的切片操作。

#### 返回结果<a id="orgheadline37"></a>
...
### 更改记录<a id="orgheadline40"></a>

更改记录经过ORM封装之后变得很简单了，就是查询之后获得对应的python对象，然后直接修改即可。

### 删除记录<a id="orgheadline41"></a>

    session.delete(jack)

## ORM层的关系<a id="orgheadline47"></a>
...
### one-to-many模型<a id="orgheadline43"></a>
...
![img](images/users_table.png "users\_table")

![img](images/emails_table.png "emails\_table")
...
### one-to-one模型<a id="orgheadline44"></a>
...
### many-to-one模型<a id="orgheadline45"></a>
...
### many-to-many模型<a id="orgheadline46"></a>
...
![img](images/many_to_many.png "many-to-many模型")
...
![img](images/tags_table.png "tags\_table")

![img](images/blogs_table.png "blogs\_table")

![img](images/blog_tags_table.png "blog\_tags\_table")
...
# 高级议题<a id="orgheadline53"></a>

## cascade<a id="orgheadline49"></a>
...
## 自我引用表达树状结构<a id="orgheadline50"></a>
...
## 面向ORM的内省机制<a id="orgheadline51"></a>
...
## 面向ORM的数据继承机制<a id="orgheadline52"></a>

有时间补上。

# 附录<a id="orgheadline59"></a>

## 其他<a id="orgheadline55"></a>

### datetime数据类型<a id="orgheadline54"></a>
