...
<ul>
<li><a href="#orgheadline1">1.1. 测试安装情况</a></li>
</ul>
</li>
<li><a href="#orgheadline3">2. 获取图片信息</a></li>
<li><a href="#orgheadline4">3. 图片格式转换</a></li>
<li><a href="#orgheadline5">4. 图片缩小尺寸</a></li>
<li><a href="#orgheadline6">5. 图片去背景边</a></li>
<li><a href="#orgheadline8">6. 附录</a>
<ul>
<li><a href="#orgheadline7">6.1. 有名的lena图</a></li>
</ul>
</li>
</ul>
</div>
...
安装官方文档的叙述<sup><a id="fnr.1" class="footref" href="#fn.1">1</a></sup>，下面这些可能需要装上。
...
![img](images/test_trim.jpg)

然后去边裁剪之后的效果为:

![img](images/test_trim_out.jpg)

# 附录<a id="orgheadline8"></a>

## 有名的lena图<a id="orgheadline7"></a>

![img](images/lena.jpg)

还有福利图。。

![img](images/lena_fuli.jpg)

<div id="footnotes">
<h2 class="footnotes">Footnotes: </h2>
<div id="text-footnotes">

<div class="footdef"><sup><a id="fn.1" class="footnum" href="#fnr.1">1</a></sup> <div class="footpara">also reference [this](http://askubuntu.com/questions/427358/install-pillow-for-python-3)</div></div>
